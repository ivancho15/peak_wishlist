...
class RefugioCreate(CreateView):
    ...
    def form_valid(self, form):
        form.instance.montana = get_object_or_404(Montana, id=self.kwargs.get('montana_id'))
        return super().form_valid(form)

    def get_success_url(self):
        return reverse_lazy('peak_wishlist:refugios_por_montana',  kwargs={'montana_id': self.kwargs.get('montana_id')})
