    ...
    def get_queryset(self) -> QuerySet[Any]:
        ...
        if query:
            queryset = queryset.filter(
                Q(ruta__nombre__icontains=query)
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        if isinstance(self.filtro, Ruta):
            ...
            context["url_volver"] = reverse_lazy(
                "peak_wishlist:ruta_detail",
                kwargs={"pk": self.filtro.pk},
            )
            context["volver_label"] = f"Volver a {self.filtro.nombre}"
...
class ExcursionUpdate(UpdateView):
            ...
            kwargs.update(
                {
                    ...
                    "m_id": self.object.ruta.montana.id # type: ignore
                    if (self.object.ruta and self.object.ruta.montana) # type: ignore
    ...
    def get_success_url(self):
        ...
        if self.object:  # type: ignore
            return reverse_lazy(
                "peak_wishlist:excursion_detail", kwargs={"pk": self.object.pk}   # type: ignore
            ) 
    ...
    def get_context_data(self, **kwargs):
        ...
        context["url_cancelar"] = (
            referer if referer else reverse_lazy("peak_wishlist:excursiones")
        )
        return context
