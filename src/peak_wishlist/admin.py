...
class MontanaAdmin(admin.ModelAdmin):
    ...
    search_fields = ('nombre', 'pais', 'cordillera', 'parque')
...
class RutaAdmin(admin.ModelAdmin):
    ...
    search_fields = ('nombre', 'montana', 'actividad')
...
class ProyectoAdmin(admin.ModelAdmin):
    ...
    search_fields = ('nombre', 'pais_destino')
